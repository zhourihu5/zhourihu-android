...
public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener,
    ...
    //单击事件广播
    private String SINGLETAPCONFIRMED="com.single.click";
    ...
    public PhotoViewAttacher(ImageView imageView) {
        ...
        if (null != observer)
        	//在一个视图树中全局布局发生改变或者视图树中的某个视图的可视状态发生改变时调用这个回调函数。
    ...
    public final boolean onSingleTapConfirmed(MotionEvent e) {
        ImageView imageView = getImageView();
        //发送单击时间广播，需要处理的类可以监听此广播
        Intent go=new Intent(SINGLETAPCONFIRMED);
        imageView.getContext().sendBroadcast(go);
