...
public class AbListViewHeader extends LinearLayout {
	...
	public TextView headerTimeView;
		...
		switch(state){
			case STATE_NORMAL:
				...
				if(lastRefreshTime==null){
					...
					headerTimeView.setText(mContext.getString(R.string.refresh_time) + lastRefreshTime);
				}else{
					headerTimeView.setText(mContext.getString(R.string.last_refresh_time) + lastRefreshTime);
				}
			...
			case STATE_READY:
				if (mState != STATE_READY) {
					...
					tipsTextview.setText(R.string.loose_to_refresh);
					headerTimeView.setText(mContext.getString(R.string.last_refresh_time) + lastRefreshTime);
					lastRefreshTime = AbDateUtil.getCurrentDate(AbDateUtil.dateFormatHMS);
			...
			case STATE_REFRESHING:
				...
				headerTimeView.setText(mContext.getString(R.string.this_refresh_time) + lastRefreshTime);
				break;
				default:
			}
